...
public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.MyViewHolder>  implements Filterable {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.videoDuration.setText(setTimer(Integer.parseInt(videoFiles.get(position).getDuration())));
...
*/
                    ...
                    myIntent.putExtra(Intent.EXTRA_STREAM, FileProvider.getUriForFile(mContext,BuildConfig.APPLICATION_ID +".provider",new File(videoFiles.get(position).getPath())));
    ...
    public  void deleteFile(int position, View v) {
        ...
        Uri uri = ContentUris.withAppendedId(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, Long.parseLong(videoFiles.get(position).getId()));
    ...
    public VideoAdapter(Context mContext, ArrayList<VideoFiles> videoFiles) {
        ...
        videoFilesFull=new ArrayList<>(videoFiles);
    ...
    private Filter exampleFilter = new Filter() {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            videoFiles.clear();
            videoFiles.addAll((List) results.values);
