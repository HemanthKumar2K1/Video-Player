...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    // vars
    ArrayList<VideoFiles> mediaObjects = new ArrayList<>();
...
//
//            DataSource.Factory factory = new DefaultDataSourceFactory(context, Util.getUserAgent(context, "RecyclerView VideoPlayer"));
...
*/
    ...
    public void setMediaObjects(ArrayList<VideoFiles> mediaObjects) {
